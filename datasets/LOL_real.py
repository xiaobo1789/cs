...
class ImagesDataset2(Dataset):
	def __init__(self, source_root_pre, target_root_pre, opts, target_transform=None, source_transform=None, train=1):
		...
		if train:
			source_root =r"E:\SMG-LLIE-main\datasets\LOL\real\Train\Low"
			target_root = r"E:\SMG-LLIE-main\datasets\LOL\real\Train\Normal"
		else:
			source_root = r"E:\SMG-LLIE-main\datasets\LOL\real\Test\Low"
			target_root = r"E:\SMG-LLIE-main\datasets\LOL\real\Test\Normal"
