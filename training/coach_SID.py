...
class Coach:
    def __init__(self, opts, prev_train_checkpoint=None):
        ...
        self.train_dataloader = DataLoader(self.train_dataset,
                                           ...
                                           sampler=data_sampler(self.train_dataset, shuffle=True),
    ...
    def load_from_train_checkpoint(self, ckpt):
        ...
        ckpt = torch.load(self.opts.resume_training_from_ckpt, map_location=self.device)
    ...
    def validate(self):
        ...
        for batch_idx, batch in enumerate(self.test_dataloader):
            ...
            with torch.no_grad():
                ...
                loss, cur_encoder_loss_dict, id_logs = self.calc_loss(x, y, y_hat_all, latent, y_hat_inter,
                                                                      y_hat_sketch, sketch)
