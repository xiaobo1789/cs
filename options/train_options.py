...
class TrainOptions:
    ...
    def initialize(self):
        # 在 initialize 方法中添加路径参数
        self.parser.add_argument('--source_root', type=str, required=True, help=r"E:\SMG-LLIE-main\data\LOL\real\Train\Low")
        self.parser.add_argument('--target_root', type=str, required=True, help=r"E:\SMG-LLIE-main\data\LOL\real\Train\Normal")
        self.parser.add_argument('--test_source_root', type=str, required=True, help=r"E:\SMG-LLIE-main\data\LOL\real\Test\Low")
        self.parser.add_argument('--test_target_root', type=str, required=True, help=r"E:\SMG-LLIE-main\data\LOL\real\Test\Normal")
            # 保留其他原有参数...
